...
import AdaptiveBookingBar from "../components/PlacePage/AdaptiveBookingBar";
import ModalBooking from "../components/PlacePage/ModalBooking";
...
export default function PlacePage() {
  ...
  const [isBookingBarVisible, setIsBookingBarVisible] = useState(true);
  ...
  return (
    <div className="relative ">
      ...
      <Pictures
        ...
        hideBar={() => setIsBookingBarVisible(false)}
      />
      <div className="block gap-10 pt-10 lg:flex mb-12 lg:mb-0">

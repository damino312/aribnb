...
export default function Pictures({ place, showGallery }) {
  return (
    ...
    />
        ...
        <button onClick={showGallery} className="py-2 px-4 border rounded absolute bottom-5 right-5 bg-gray-300 hover:-translate-y-4 hover:bg-primary hover:text-white transition-all">See all photos</button>
      </div>
    </div>
  );
}
